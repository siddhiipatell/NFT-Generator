...
def generate_images(edition, count, drop_dup=True):
    ...
    # Create the final rarity table by removing duplicate creations
...
def main():
    ...
    print("You can create a total of %i distinct nfts" % (tot_comb))
    print()

    print("How many nfts would you like to create? Enter a number greater than 0: ")
    while True:
        num_nfts = int(input())
        if num_nfts > 0:
            break
    ...
    print("Starting task...")
    rt = generate_images(edition_name, num_nfts)
